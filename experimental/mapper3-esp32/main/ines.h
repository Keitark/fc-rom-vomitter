...
#define NESCART_CHR_BANK_SIZE (8u * 1024u)
#define NESCART_CHR_BANKS_MAX 2u
#define NESCART_CHR_SIZE (NESCART_CHR_BANK_SIZE * NESCART_CHR_BANKS_MAX)
#define NESCART_IMAGE_SIZE (NESCART_PRG_SIZE + NESCART_CHR_SIZE)
#define NESCART_MAX_INES_SIZE (16u + 512u + NESCART_IMAGE_SIZE)

typedef enum {
    NESCART_MAPPER_NROM = 0,
    NESCART_MAPPER_CNROM = 3,
} nescart_mapper_t;
